...
use GisConverter\Decoder\DecoderInterface;
use GisConverter\Decoder\WktDecoder;

class WktDecoderTest extends \PHPUnit_Framework_TestCase {
	/** @var DecoderInterface */
	private $decoder;

	public function setUp() {
		$this->decoder = new WktDecoder();
	}
